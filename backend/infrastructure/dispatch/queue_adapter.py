...
def get_status(*args: Any, **kwargs: Any) -> Any:
    """Adapter: statut dispatch (proxy vers services.unified_dispatch.queue)."""
    from services.unified_dispatch.queue import get_status as _get_status

    return _get_status(*args, **kwargs)


def trigger_job(*args: Any, **kwargs: Any) -> Any:
    """Adapter: enqueue dispatch (proxy vers services.unified_dispatch.queue)."""
    from services.unified_dispatch.queue import trigger_job as _trigger_job
...
def trigger_on_booking_change(*args: Any, **kwargs: Any) -> Any:
    ...
    from services.unified_dispatch.queue import (
...
def trigger(*args: Any, **kwargs: Any) -> Any:
    ...
    from services.unified_dispatch.queue import trigger as _trigger
