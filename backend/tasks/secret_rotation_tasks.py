    ...
    try:
        ...
        with app.app_context():
            ...
            logger.info(
                ...
                model_name, field_name, batch_size
            )
            ...
            if field_name:
                ...
                encrypted_fields = [
                    "contact_phone_encrypted", "gp_name_encrypted",
                    "gp_phone_encrypted", "billing_address_encrypted"
                ]
                ...
                for record in records:
                    try:
                        ...
                        for field in encrypted_fields:
                            ...
                            try:
                                ...
                                logger.warning(
                                    ...
                                    model_name, field, getattr(record, "id", "?"), decrypt_err
                                )
                                errors.append({
                                    "model": model_name,
                        ...
                        logger.error(
                            ...
                            model_name, getattr(record, "id", "?"), e
                        )
                        errors.append({
                            "model": model_name,
                            "id": getattr(record, "id", None),
