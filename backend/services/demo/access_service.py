...
def _seed_transport_demo_workspace(
    ...
    *,
    ...
    for idx in range(drivers_target):
        ...
        driver_user.set_password(  # nosemgrep: python.django.security.audit.unvalidated-password.unvalidated-password
    ...
    for idx in range(clients_target):
        ...
        patient_user.set_password(  # nosemgrep: python.django.security.audit.unvalidated-password.unvalidated-password
            get_demo_default_password()
        )
    ...
    *,
    ...
    if not demo_company:
        ...
        if not owner:
            ...
            owner.set_password(  # nosemgrep: python.django.security.audit.unvalidated-password.unvalidated-password
                get_demo_default_password()
            )
    ...
    if demo_company:
        ...
        if not demo_client_user:
            ...
            demo_client_user.set_password(  # nosemgrep: python.django.security.audit.unvalidated-password.unvalidated-password
                get_demo_default_password()
            )
