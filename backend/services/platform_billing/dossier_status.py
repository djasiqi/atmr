...
ACTION_CAPABILITY: dict[str, str | None] = {
    ...
    ACTION_CLOSE_PERIOD: CAP_BILLING_LOCK,
...
def resolve_actions(
    *,
    ...
    if status == STATUS_A_CALCULER:
        ...
        primary = ACTION_CLOSE_PERIOD if _can(ACTION_CLOSE_PERIOD) else ACTION_VIEW
        _add(ACTION_CLOSE_PERIOD)
        _add(ACTION_REVIEW)
