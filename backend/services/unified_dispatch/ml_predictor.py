...
class DelayMLPredictor:
    ...
    def _calculate_driver_punctuality(self, driver: Any) -> float:
        ...
        Basé sur l'historique (placeholder pour l'instant).
        """
        # TODO: Calculer depuis l'historique réel
...
_global_predictor: Optional[DelayMLPredictor] = None


def get_ml_predictor(model_path: Optional[str] = None) -> DelayMLPredictor:
