...
class ParetoFront:
    ...
    def select_best(self, fairness_weight: float) -> ParetoSolution | None:
    ...
    def _is_dominated(self, solution: ParetoSolution, other: ParetoSolution) -> bool:
...
def calculate_fairness_score(assignments: List[Dict[str, Any]]) -> float:
