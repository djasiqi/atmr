...
class DemandPredictor:
    ...
    def predict_demand_for_zone(
        ...
        try:
            ...
            is_weekend_init = target_date.weekday() >= 5
            ...
            for h in range(24):
                ...
                # Facteur rush hour
                is_rush = 7 <= future_hour <= 9 or 17 <= future_hour <= 19
            ...
            is_rush_init = 7 <= target_date.hour <= 9 or 17 <= target_date.hour <= 19
            factors = {
    ...
    def _get_historical_data_for_zone(self, zone_id: str) -> pd.DataFrame | None:
        ...
        try:
            ...
            df_resampled = df_grouped.resample("H").sum().fillna(0)
    ...
    def _fallback_prediction(self, zone_id: str, target_date: datetime) -> ZoneDemandPrediction:
        ...
        is_weekend_value = target_date.weekday() >= 5
        is_rush_value = 7 <= target_date.hour <= 19
