...
class DayReplayer:
    ...
    def replay_day(
        ...
        logger.info(
            ...
            target_date, len(bookings), len(drivers), len(policies), n_iterations
        )
        ...
        for policy in policies:
            ...
            for iteration in range(n_iterations):
                logger.debug(
                    ...
                    policy, iteration + 1, n_iterations
                )
            ...
            logger.info(
                ...
                policy, aggregated.assignments_count, aggregated.fairness_score
            )
