...
"""Script de validation pour les corrections d'Action Masking.
...
def validate_action_masking_fixes():
    ...
    logger.info("🔧 Validation des corrections d'Action Masking")
    logger.info("=" * 60)
...
def test_index_protection():
    ...
    invalid_actions = [env.action_space.n, env.action_space.n + 1, -1]
