...
class InstitutionPatientList(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            if requires_minor_dob_confirmation(new_dob=dob_parsed) and not minor_confirmed:
                return {
            ...
            try:
                ...
                AuditLogger.log_action(
                    ...
                    action_details={
                        ...
                        "minor_dob_confirmed": bool(minor_confirmed) if minor_at_save else False,
                        "confirmed_by_user_id": user_id if minor_at_save and minor_confirmed else None,
                        "confirmed_at": (
