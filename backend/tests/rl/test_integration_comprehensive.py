...
class TestRLIntegration:
    ...
    def test_action_masking_integration(self, ____________________________________________________________________________________________________mock_agent, mock_env):
        ...
        mock_env._get_valid_actions_mask.return_value = np.array([
            ...
            False, True, False, True, False,  # Driver 6
            True, True, False, False, True,  # Driver 7
            False, False, True, True, False,  # Driver 8
            True, False, True, False, True,  # Driver 9
            False, True, False, True, False   # Driver 10
        ])
