...
class TestClusteringStitching:
    ...
    def test_cluster_creation(self):
        ...
        bookings = [
            MockBooking(i, 45.5 + i * 0.01, -73.5 + i * 0.01)
            for i in range(150)
        ]
        drivers = [
            MockDriver(i, 45.5, -73.5)
            for i in range(20)
        ]
    ...
    def test_cluster_solve_stitch_300(self):
        ...
        logger.info(
            ...
            elapsed, total_assignments, total_unassigned
        )
    ...
    def test_parallel_zone_solving(self):
        ...
        bookings = [
            MockBooking(i, 45.0 + i * 0.01, -73.0 + i * 0.01)
            for i in range(200)
        ]
        drivers = []
        ...
        def solve_zone(zone):
            # Mock solve
            return {
                "assignments": len(zone.bookings) - 5,
                "unassigned": 5
            }
        ...
        logger.info(
            "✅ Test: Parallel solve de %d zones en %.2fs",
            len(zones), elapsed
        )
    ...
    def test_constraint_validator(self):
        ...
        zone_results = {
            z.zone_id: {
                "assignments": list(range(len(z.bookings))),
                "unassigned": []
            }
            for z in zones
        }
