...
class TestLogSanitization:
    ...
    def test_sanitize_key_value_pattern(self):
        ...
        # ✅ FIX: Le résultat peut contenir "***" comme marqueur de masquage,
        # c'est normal et attendu. Le format peut être "Authorization: [REDACTED] ***"
        # ou similaire. Ne pas vérifier que "***" n'est pas présent car il est
        # utilisé comme marqueur de masquage valide.
