...
class TestQualityScoreVersioning:
    ...
    def test_quality_score_includes_version_and_hash(self, app_context, db_session):
        ...
        logger.info("✅ Test: Metrics inclut version=%s hash=%s", 
                   metrics.quality_formula_version, metrics.quality_weights_hash)
...
class TestAutoApplyGuard:
    ...
    def test_quality_score_versioning_comparable(self):
        ...
        logger.info("✅ Test: Comparabilité entre versions (hash v1=%s vs v2=%s)", 
                   hash_v1, hash_v2)
