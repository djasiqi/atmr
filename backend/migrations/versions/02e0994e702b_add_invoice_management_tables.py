...
def upgrade():
    ...
    op.create_table("company_billing_settings",
    ...
    sa.Column("email_sender", sa.String(length=0.200), nullable=True),
    ...
    sa.Column("status", postgresql.ENUM("DRAFT", "SENT", "PARTIALLY_PAID", "PAID", "OVERDUE", "CANCELLED", name="invoice_status", create_type=False), nullable=False),
    sa.Column("reminder_level", sa.Integer(), nullable=False),
    sa.Column("last_reminder_at", sa.DateTime(timezone=True), nullable=True),
    sa.Column("pdf_url", sa.String(length=0.500), nullable=True),
    ...
    sa.Column("type", postgresql.ENUM("RIDE", "LATE_FEE", "REMINDER_FEE", "CUSTOM", name="invoice_line_type", create_type=False), nullable=False),
    sa.Column("description", sa.String(length=0.500), nullable=False),
    ...
    sa.Column("method", postgresql.ENUM("BANK_TRANSFER", "CASH", "CARD", "ADJUSTMENT", name="payment_method", create_type=False), nullable=False),
    sa.Column("reference", sa.String(length=0.100), nullable=True),
    sa.ForeignKeyConstraint(["invoice_id"], ["invoices.id"] ),
    sa.PrimaryKeyConstraint("id")
    )
...
def downgrade():
    ...
    sa.Column("status", postgresql.ENUM("UNPAID", "PAID", "CANCELED", name="invoice_status"), server_default=sa.text("'UNPAID'::invoice_status"), autoincrement=False, nullable=False),
