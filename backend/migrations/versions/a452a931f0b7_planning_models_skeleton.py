...
def upgrade():
    ...
    sa.Column("type", sa.Enum("regular", "standby", "replacement", "training", "maintenance", name="shift_type"), server_default="regular", nullable=False),
    sa.Column("status", sa.Enum("planned", "active", "completed", "cancelled", name="shift_status"), server_default="planned", nullable=False),
    sa.Column("site", sa.String(length=0.120), nullable=True),
    sa.Column("zone", sa.String(length=0.120), nullable=True),
    sa.Column("client_ref", sa.String(length=0.120), nullable=True),
    ...
    op.create_table("driver_unavailability",
    sa.Column("id", sa.Integer(), nullable=False),
    sa.Column("company_id", sa.Integer(), nullable=False),
    sa.Column("driver_id", sa.Integer(), nullable=False),
    sa.Column("start_local", sa.DateTime(), nullable=False),
    sa.Column("end_local", sa.DateTime(), nullable=False),
    sa.Column("reason", sa.Enum("vacation", "sick", "break", "personal", "other", name="unavailability_reason"), server_default="other", nullable=False),
    ...
    op.create_table("driver_weekly_template",
    sa.Column("id", sa.Integer(), nullable=False),
    sa.Column("company_id", sa.Integer(), nullable=False),
    sa.Column("driver_id", sa.Integer(), nullable=False),
    ...
    op.create_table("driver_break",
    sa.Column("id", sa.Integer(), nullable=False),
    sa.Column("shift_id", sa.Integer(), nullable=False),
    sa.Column("start_local", sa.DateTime(), nullable=False),
    sa.Column("end_local", sa.DateTime(), nullable=False),
    sa.Column("type", sa.Enum("mandatory", "optional", name="break_type"), server_default="mandatory", nullable=False),
