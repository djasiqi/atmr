...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("ADMIN", "CLIENT", "DRIVER", "COMPANY", name="user_role"),
    ...
    op.create_table(
        ...
        sa.Column("domicile_address_line1", sa.String(length=200), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "client_type",
            sa.Enum("SELF_SERVICE", "PRIVATE", "CORPORATE", name="client_type"),
        ...
        sa.Column("domicile_address", sa.String(length=255), nullable=True),
        sa.Column("domicile_zip", sa.String(length=10), nullable=True),
        sa.Column("domicile_city", sa.String(length=100), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "vacation_type",
            sa.Enum("VACANCES", "MALADIE", "CONGES", "AUTRE", name="vacation_type"),
            server_default="VACANCES",
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "state",
            sa.Enum("AVAILABLE", "BUSY", "OFFLINE", name="driver_state"),
