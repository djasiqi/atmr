...
def upgrade():
    ...
    with op.batch_alter_table("autonomous_action", schema=None) as batch_op:
        batch_op.alter_column("reviewed_by_admin",
    ...
    with op.batch_alter_table("company", schema=None) as batch_op:
        batch_op.alter_column("dispatch_mode",
    ...
    with op.batch_alter_table("rl_suggestion_metrics", schema=None) as batch_op:
        batch_op.alter_column("confidence",
               existing_type=sa.DOUBLE_PRECISION(precision=53),
               nullable=True)
        batch_op.alter_column("expected_gain_minutes",
...
def downgrade():
    ...
    with op.batch_alter_table("rl_suggestion_metrics", schema=None) as batch_op:
        ...
        batch_op.create_unique_constraint("rl_suggestion_metrics_suggestion_id_key", ["suggestion_id"], postgresql_nulls_not_distinct=False)
        batch_op.alter_column("expected_gain_minutes",
               existing_type=sa.INTEGER(),
               nullable=True,
               existing_server_default=sa.text("0"))
    ...
    with op.batch_alter_table("driver_status", schema=None) as batch_op:
        batch_op.create_index("ix_driver_status_assignment", ["current_assignment_id"], unique=False, postgresql_where="(current_assignment_id IS NOT NULL)")
    ...
    with op.batch_alter_table("booking", schema=None) as batch_op:
        batch_op.create_index("ix_booking_status_scheduled_company", ["status", "scheduled_time", "company_id"], unique=False)
        batch_op.create_index("ix_booking_invoice_line", ["invoice_line_id"], unique=False, postgresql_where="(invoice_line_id IS NOT NULL)")
    ...
    with op.batch_alter_table("autonomous_action", schema=None) as batch_op:
        ...
        batch_op.create_index("ix_autonomous_action_company_created", ["company_id", "created_at", "success"], unique=False)
        batch_op.alter_column("reviewed_by_admin",
               existing_type=sa.BOOLEAN(),
               nullable=False)
    ...
    with op.batch_alter_table("assignment", schema=None) as batch_op:
        ...
        batch_op.create_index("ix_assignment_dispatch_run", ["dispatch_run_id"], unique=False, postgresql_where="(dispatch_run_id IS NOT NULL)")
