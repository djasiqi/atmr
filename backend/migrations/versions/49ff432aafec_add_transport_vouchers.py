...
def _fk_exists(bind, table_name: str, column_name: str, referred_table: str, schema: str = "public"):
    """Vrai si une FK existe de (table, column) vers (referred_table, id)."""
    return _get_fk_constraint_name(bind, table_name, column_name, referred_table, schema) is not None
...
def upgrade():
    ...
    with op.batch_alter_table("booking", schema=None) as batch_op:
        ...
        if not _constraint_exists(conn, "booking", "booking_billing_locked_by_user_id_fkey"):
...
def downgrade():
    ...
    with op.batch_alter_table("booking", schema=None) as batch_op:
        fk_name = _get_fk_constraint_name(conn, "booking", "billing_locked_by_user_id", "user")
        if fk_name:
