...
function DriverSidePanel({ driver, onUpdate }) {
  ...
  const save = () => {
    const payload = {
      ...
      hourly_rate_cents: form.hourly_rate_cents === '' ? null : Number(form.hourly_rate_cents),
      ...
      <div className={styles.formGrid}>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => setForm({ ...form, employment_end_date: e.target.value })}
          />
        </div>
        <div style={{ gridColumn: '1 / span 2' }}>
          ...
          <input
            ...
            onChange={(e) => setForm({ ...form, license_categories: e.target.value })}
          />
        </div>
        <div>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => setForm({ ...form, medical_valid_until: e.target.value })}
          />
        </div>
      </div>
      <div className={styles.spacer}></div>
      <button className={`${styles.button} ${styles.buttonPrimary}`} onClick={save}>
        Enregistrer
      </button>
    </aside>
  );
...
function CompanyDriverPlanning() {
  ...
  const [rangeTo, setRangeTo] = useState(() => new Date(Date.now() + 7 * 86400000));
            ...
            {selectedDriver && (
              <div className={styles.grid} style={{ marginBottom: 12 }}>
                <div className={styles.card}>
                  ...
                  <div>Nom: {selectedDriver.full_name || selectedDriver.username}</div>
                  ...
                  <div className={styles.kpis}>
                    ...
                    <div className={styles.kpi}>
                      ...
                      <div className={styles.kpiValue}>
                        {shifts.reduce((m, s) => m + minutesBetween(s.start_local, s.end_local), 0)}{' '}
                        min
                      </div>
                    </div>
                  </div>
