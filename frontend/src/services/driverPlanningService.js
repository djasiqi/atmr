...
export const fetchShifts = async ({
  ...
  const { data } = await apiClient.get(
    `/companies/me/planning/shifts?${params.toString()}`
  );
  return data;
};
...
export const updateShift = async (_companyId, id, payload) => {
  const { data } = await apiClient.put(
    `/companies/me/planning/shifts/${id}`,
    payload
  );
  return data;
};
...
export const createUnavailability = async (payload) => {
  const { data } = await apiClient.post(
    `/companies/me/planning/unavailability`,
    payload
  );
  return data;
};
...
export const deleteUnavailability = async (id) => {
  const { data } = await apiClient.delete(
    `/companies/me/planning/unavailability/${id}`
  );
  return data;
};
...
export const saveWeeklyTemplate = async (payload) => {
  const { data } = await apiClient.post(
    `/companies/me/planning/templates/weekly`,
    payload
  );
  return data;
};
...
export const materializeTemplate = async (payload) => {
  const { data } = await apiClient.post(
    `/companies/me/planning/templates/materialize`,
    payload
  );
  return data;
};
...
export const updatePlanningSettings = async (payload) => {
  const { data } = await apiClient.put(
    `/companies/me/planning/settings`,
    payload
  );
  return data;
};
...
export const fetchAssignments = async ({ from, to, driverId }) => {
  ...
  if (driverId) params.append("driver_id", driverId);
  const { data } = await apiClient.get(
    `/companies/me/planning/assignments?${params.toString()}`
  );
  return data;
};
...
export const exportICS = async ({ driverId, from, to }) => {
  ...
  if (to) params.append("to", to);
  const { data } = await apiClient.get(
    `/companies/me/planning/export/ics?${params.toString()}`
  );
  return data;
};
...
export const exportCSV = async (paramsObj) => {
  ...
  const { data } = await apiClient.get(
    `/companies/me/planning/export/csv?${params.toString()}`
  );
  return data;
};
...
export const exportPDF = async (paramsObj) => {
  const params = new URLSearchParams(paramsObj || {});
  const { data } = await apiClient.get(
    `/companies/me/planning/export/pdf?${params.toString()}`
  );
  return data;
};
...
export const fetchDriverVacations = async (driverId) => {
  ...
  const { data } = await apiClient.get(
    `/companies/me/drivers/${driverId}/vacations`
  );
