...
export const fetchCompanyDriversCanonical = async () => {
  ...
  return (drivers || []).map((drv) => {
    ...
    return {
      ...
      tracking_display_status: loc.tracking_display_status ?? drv.tracking_display_status ?? null,
      position_source: loc.position_source ?? drv.position_source ?? null,
      offline_reason: loc.offline_reason ?? drv.offline_reason ?? null,
      ...
      timestamp: loc.timestamp ?? drv.timestamp ?? null,
        ...
        try {
          ...
          return {
            ...
            driver_name: b.driver_name
              || a?.driver?.full_name
              || (a?.driver?.user
                ? `${a.driver.user.first_name || ''} ${a.driver.user.last_name || ''}`.trim() || null
                : null),
