...
checkGitTracked("assets/images/adaptive-foreground.png", "Adaptive Android (192, adaptive-foreground.png)");
checkGitTracked("assets/images/apple-touch-icon.png", "Apple touch / splash (180, apple-touch-icon.png)");
