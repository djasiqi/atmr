...
- L'override force toutes les dépendances transitives (expo, expo-constants, etc.) à utiliser la version corrigée
- La mise à jour d'Expo SDK vers une version plus récente pourrait résoudre le problème à la source, mais l'override reste une solution de sécurité efficace
