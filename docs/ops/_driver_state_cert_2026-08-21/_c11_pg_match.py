...
IDS = [x for x in '''trk_1787344641736_d547da78,trk_1787344702736_c83d9524,trk_1787344763736_d477b635,trk_1787344819848_ab70772d,trk_1787344874735_7f9b8010'''.split(',') if x]
app = create_app()
with app.app_context():
    ...
    print('PROJECTION_IN_SET', bool(drv and drv['last_location_event_id'] in IDS))
    print('PROJECTION_AVANCE', bool(drv and drv['last_location_event_id']))
