...
def _payload_hash(payload: dict[str, Any]) -> str:
    """Alias v1 : hash legacy sans capture_id (P0-D canary)."""
...
def persist_location_event_with_outbox(
    ...
    *,
    ...
    # Hash v1 : sous-ensemble stable (sans champs transport / capture_id).
    hash_payload = {
        "driver_id": driver_id,
    ...
    payload = {**hash_payload, **(extra_payload or {})}
    # Ne jamais laisser capture_id polluer le hash v1.
